...
// O funcție utilitară pentru a imprima fișierul construit stocat în părinte []
...
// Funcție pentru construirea și tipărirea arborelui minim de acoperire pentru
// un grafic reprezentat folosind adiacența
...
void Mos_Craciun::primMST(int graph[V][V])
{
	...
	int key[V];// Valori cheie utilizate pentru a alege marginea greutății minime în tăietură
	...
	key[0] = 0;//faceți tasta 0 astfel încât acest vârf să fie ales ca primul vârf.
	parent[0] = -1;

	for (int count = 0; count < V - 1; count++)
	{
		// Alegem vârful cheii minime din
		// set de vârfuri care nu sunt încă incluse în arborele minim
		int u = minKey(key, mstSet);
		// Adăugam vârful ales în setul arborele minim
		mstSet[u] = true;
	   ...
	   // mstSet [v] este fals pentru vârfurile care nu sunt încă incluse în MST
	  // Actualizați cheia numai dacă graficul [u] [v] este mai mic decât cheia [v]
	}
